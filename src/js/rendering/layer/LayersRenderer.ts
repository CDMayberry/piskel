...
module pskl {
    export module rendering {
        export module layer {
            export class LayersRenderer extends CompositeRenderer {
                piskelController: any;
                belowRenderer: frame.FrameRenderer;
                aboveRenderer: frame.FrameRenderer;
                serializedRendering: string;
                stylesheet_: HTMLStyleElement;

                constructor(container, renderingOptions, piskelController) {
                    super();
                ...
                private onUserSettingsChange_(evt, settingsName, settingsValue) {
                    if (settingsName == pskl.UserSettings.LAYER_OPACITY) {
                        this.updateLayersCanvasOpacity_(settingsValue);
                    }
                }

                private updateLayersCanvasOpacity_(opacity) {
                    this.stylesheet_.innerHTML = '.layers-canvas { opacity : ' + opacity + '}';
                }
