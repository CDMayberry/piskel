        ...
        export module keyboard {
            export const KeyUtils = {
                ...
                createKeyFromEvent: function (evt) {
                    ...
                    var key = KeycodeTranslator.toChar(keycode);
                    if (!key) {
                        return null;
                    }
                    ...
                    return {
                        ...
                        modifiers: {
                            alt: evt.altKey,
                            shift: evt.shiftKey,
                            ctrl: KeyUtils.isCtrlKeyPressed_(evt)
                        }
                    };
                },

                equals: function (key1, key2) {
                    key1 = typeof key1 === 'string' ? KeyUtils.createKeyFromString(key1) : key1;
                    key2 = typeof key2 === 'string' ? KeyUtils.createKeyFromString(key2) : key2;
                ...
                stringify: function (shortcutKeyObject) {
                    var modifierString = KeyUtils.getModifiersString(shortcutKeyObject.modifiers);
                    if (modifierString) {
