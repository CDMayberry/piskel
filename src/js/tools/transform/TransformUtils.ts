            ...
            export const TransformUtils = {
                ...
                flip: function (frame, axis) {
                    ...
                    clone.forEachPixel(function (color, x, y) {
                        if (axis === TransformUtils.VERTICAL) {
                            x = w - x - 1;
                        } else if (axis === TransformUtils.HORIZONTAL) {
                            y = h - y - 1;
                        }
                ...
                rotate: function (frame, direction) {
                    ...
                    frame.forEachPixel(function (color, x, y) {
                        ...
                        var tmpX = x;
                        var tmpY = y;
                        if (direction === TransformUtils.CLOCKWISE) {
                            x = tmpY;
                            y = max - 1 - tmpX;
                        } else if (direction === TransformUtils.COUNTERCLOCKWISE) {
                            y = tmpX;
                            x = max - 1 - tmpY;
                        }
                ...
                center: function (frame) {
                    ...
                    var boundaries = TransformUtils.getBoundaries([frame]);
                    ...
                    TransformUtils.moveFramePixels(frame, dx, dy);
                    return frame;
                }
            };
        }
