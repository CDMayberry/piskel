module pskl {
    export module utils {
        export module CanvasUtils {
            export function createCanvas (width, height, classList?) {
                ...
                if (window.Array.isArray(classList)) {
              ...
              export function createFromImageData (imageData) {
              ...
              export function createFromImage (image) {
               ...
               */
              export function createFramesFromImage (image, offsetX, offsetY, width, height, useHorizonalStrips, ignoreEmptyFrames) {
                var canvasArray = [];
                var x = offsetX;
                var y = offsetY;
               ...
               * @param  {Canvas} canvas
               */
              export function disableImageSmoothing (canvas) {
                pskl.utils.CanvasUtils.setImageSmoothing(canvas, false);
              }
          
              export function enableImageSmoothing (canvas) {
                pskl.utils.CanvasUtils.setImageSmoothing(canvas, true);
              }
          
              export function setImageSmoothing (canvas, smoothing) {
                var context = canvas.getContext('2d');
              ...
              export function getBase64FromCanvas (canvas, format) {
                format = format || 'png';
