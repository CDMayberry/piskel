module pskl {
    ...
    export module PixelUtils {
        export function getRectanglePixels(x0, y0, x1, y1) {
         ...
         */
        export function getSimilarConnectedPixelsFromFrame(frame, col, row) {
         ...
         */
        export function resizePixel(col, row, size) {
            var pixels = [];
         ...
         * @return {Array}  array of arrays of 2 Numbers (eg. [[0,0], [0,1], [1,0], [1,1]])
         */
        export function resizePixels(pixels, size) {
         ...
         * @return an array of the pixel coordinates paint with the replacement color
         */
        export function paintSimilarConnectedPixelsFromFrame(frame, col, row, replacementColor) {
            /**
         ...
         */
        export function visitConnectedPixels(pixel, frame, pixelVisitor) {
            var col = pixel.col;
            var row = pixel.row;
         ...
         */
        export function calculateZoomForContainer(container, pictureHeight, pictureWidth) {
